...
import { ChainId, MASTERCHEF_ADDRESS, MASTERCHEF_V2_ADDRESS, MINICHEF_ADDRESS, Token } from 'souvlaswap-core-sdk'
...
const APPROVAL_ADDRESSES = {
  ...
  [Chef.MASTERCHEF]: { [ChainId.KOVAN]: MASTERCHEF_ADDRESS[ChainId.KOVAN] },
  [Chef.MASTERCHEF_V2]: { [ChainId.ETHEREUM]: MASTERCHEF_V2_ADDRESS[ChainId.ETHEREUM] },
  [Chef.MASTERCHEF_V2]: { [ChainId.KOVAN]: MASTERCHEF_V2_ADDRESS[ChainId.KOVAN] },
  [Chef.MINICHEF]: {
    [ChainId.MATIC]: MINICHEF_ADDRESS[ChainId.MATIC],
    [ChainId.XDAI]: MINICHEF_ADDRESS[ChainId.XDAI],
    [ChainId.KOVAN]: MINICHEF_ADDRESS[ChainId.KOVAN],
