...
export default function Stake() {
  ...
  const sushiBalance = useTokenBalance(account ?? undefined, SUSHI[ChainId.KOVAN])
  ...
  return (
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        <title key="title">Stake | SOUVLA</title>
        <meta
          key="description"
          name="description"
          content="Stake SOUVLA in return for xSOUVLA, an interest bearing and fungible ERC20 token designed to share revenue generated by all SOUVLA products."
        />
        ...
        <meta key="og:title" property="og:title" content="STAKE SOUVLA" />
          ...
          <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
            <div className="flex max-w-lg">
              <div className="self-end mb-3 text-lg font-bold md:text-2xl text-high-emphesis md:mb-7">
                {i18n._(t`Maximize yield by staking SOUVLA for xSOUVLA`)}
              </div>
            ...
            <div className="max-w-lg pr-3 mb-2 text-sm leading-5 text-gray-500 md:text-base md:mb-4 md:pr-0">
              {i18n._(t`For every swap on the exchange on every chain, 0.05% of the swap fees are distributed as SOUVLA
                                proportional to your share of the SouvlaBar. When your SOUVLA is staked into the SouvlaBar, you receive
                                xSOUVLA in return for voting rights and a fully composable token that can interact with other protocols.
                                Your xSOUVLA is continuously compounding, when you unstake you will receive all the originally deposited
                                SOUVLA and any additional from fees.`)}
            </div>
            {/* <div className="flex">
              ...
              <div className="w-full max-w-xl px-3 pt-2 pb-6 rounded bg-dark-900 md:pb-9 md:pt-4 md:px-8">
                ...
                <div className="flex items-center justify-between w-full mt-6">
                  <p className="font-bold text-large md:text-2xl text-high-emphesis">
                    {activeTab === 0 ? i18n._(t`Stake SOUVLA`) : i18n._(t`Unstake`)}
                  </p>
                  <div className="border-gradient-r-pink-red-light-brown-dark-pink-red border-transparent border-solid border rounded-3xl px-4 md:px-3.5 py-1.5 md:py-0.5 text-high-emphesis text-xs font-medium md:text-base md:font-normal">
                    {`1 xSOUVLA = ${Number(bar?.ratio ?? 0)?.toFixed(4)} SOUVLA`}
                  </div>
                </div>
                ...
                <div className="relative w-full h-0 pointer-events-none bottom-14">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        {`${input ? input : '0'} ${activeTab === 0 ? '' : 'x'}SOUVLA`}
                      </p>
                    </div>
                ...
                <div className="flex flex-col flex-grow md:mb-14">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">xSOUVLA</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center ml-8 space-x-4 md:ml-0">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">SOUVLA</p>
                    </div>
                  </div>
                </div>
