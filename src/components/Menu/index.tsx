...
const items = (i18n: I18n) => [
  {
    name: i18n._(t`Docs`),
    description: i18n._(t`Documentation for users of Souvla.`),
    href: "https://docs.sushi.com",
  },
  {
    name: i18n._(t`Dev`),
    description: i18n._(t`Documentation for developers of Souvla.`),
    href: "https://dev.sushi.com",
  },
  {
    name: i18n._(t`Open Source`),
    description: i18n._(t`Souvla is a supporter of Open Source.`),
    href: "https://github.com/ninja-1337/souvlaswap-interface",
  },
  {
    name: i18n._(t`Tools`),
